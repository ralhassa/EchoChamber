...
$mysqli = mysqli_connect ('mansci-db.uwaterloo.ca', 'cmacrae', 'Winter@*%2018', 'cmacrae');
    ...
    <section id="services">
      <div class="container">
        <div class="row">
          ...
          <button type="submit" value="criticlist">My crtics </button>
          </form>
         <br><br><br>
         <form action= "code5.php" method= "get">
          ...
          <button type="submit" value="moviesreviewed">Movies that I have reviewed</button>
          </form>
          </div>
      </div>
      </div>
